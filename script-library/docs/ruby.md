...
**We've currently migrated the `ruby` Feature to
[devcontainers/features/src/ruby](https://github.com/devcontainers/features/tree/main/src/ruby).**
...
_Installs Ruby, rvm, rbenv, common Ruby utilities, and needed dependencies._
...
The `ENV` parameters are technically optional, but allow the default `rvm`
installed version of Ruby to be used in non-interactive terminals and shell
scripts.
