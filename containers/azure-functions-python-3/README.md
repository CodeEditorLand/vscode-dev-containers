...
_Develop Azure Functions in Python. Includes Python 3, the Azure Functions SDK,
Docker CLI (required to publish to Azure with native dependencies) and related
...
| _Languages, platforms_      | Azure Functions, Python  |
